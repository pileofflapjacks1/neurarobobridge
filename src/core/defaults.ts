...
> &
  ...
  return {
    ...
    skills: {
      ...
      defaultStepTimeoutMs: partial.skills?.defaultStepTimeoutMs ?? 8000,
      skillTimeoutMs: partial.skills?.skillTimeoutMs ?? 60_000,
      safeFailRecovery: partial.skills?.safeFailRecovery ?? true,
      needsHelpOnFailure: partial.skills?.needsHelpOnFailure ?? true,
